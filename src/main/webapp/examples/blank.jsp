        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="../members/detail.jsp" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Validation</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="../members/list.jsp" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Simple Tables</p>
                </a>
              </li>
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    <a href="../members/success.jsp" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
              ...
              <li class="nav-item">
                <a href="../main/starter.html" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Starter Page</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            <a href="../main/iframe.html" class="nav-link">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>스크립틀릿: <%= request.getAttribute("input")%>, EL: ${requestScope.input}</h1>
          </div>
          <div class="col-sm-6">
