          ...
          <div class="card card-primary">
            ...
            <div class="card-body">
              <div class="form-group">
                ...
                <input type="text" id="inputName" name = "project-name" class="form-control">
              </div>
              <div class="form-group">
                <label for="inputDescription">Project Description</label>
                <textarea id="inputDescription" name = "project-description" class="form-control" rows="4"></textarea>
              </div>
              <div class="form-group">
